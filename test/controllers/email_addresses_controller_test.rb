...
class EmailAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email_address" do
    assert_difference('EmailAddress.count') do
      post email_addresses_url, params: { email_address: { email: @email_address.email, user_name: @email_address.user_name } }
    end
  ...
  test "should update email_address" do
    patch email_address_url(@email_address), params: { email_address: { email: @email_address.email, user_name: @email_address.user_name } }
